...
public class ContainerMetricsRawRequestDTO {
    ...
    public ContainerMetricsRequestDTO toFlatDTO() {
        return ContainerMetricsRequestDTO.builder()
                ...
                .isCpuUnlimited(cpu != null ? cpu.getIsCpuUnlimited() : false)
                ...
                .isMemoryUnlimited(memory != null ? memory.getIsMemoryUnlimited() : false)
                // Network
                ...
                .isStorageUnlimited(storage != null ? storage.getIsStorageUnlimited() : false)
