...
CREATE TABLE agents (
    ...
    os_type VARCHAR2(50) NOT NULL,
    docker_version VARCHAR2(50) NOT NULL,
...
CREATE TABLE alert_rules (
    ...
    info_threshold NUMBER(5,2) NOT NULL,
    warning_threshold NUMBER(5,2) NOT NULL,
    high_threshold NUMBER(5,2) NOT NULL,
    critical_threshold NUMBER(5,2) NOT NULL,
